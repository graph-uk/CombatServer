/*! VLAD DVORYANKIN: line 11: this > window - because of use strict
 * Glide.js v3.2.2
...
(function (global, factory) {
  ...
  function Controls (Glide, Components, Events) {
    ...
    var Controls = {
      ...
      click: function click(event) {
        ...
        // console.log(combat._sliderInstace.index + " out of " + combat.slides.all);
        var mydiv = document.getElementById('test_number_counter');
        // console.log(mydiv)
          mydiv.innerHTML=combat._sliderInstace.index+1 + " out of " + combat.slides.all;
          // mydiv.text(combat._sliderInstace.index + " out of " + combat.slides.all);
  ...
  // document.querySelectorAll('.glide__arrow').forEach(function (item, index) {
  //     item.addEventListener('click', function () {
  //         console.log(combat._sliderInstace.index + " out of " + combat.slides.all)
  //     })
  // })
